	...
	<div>
		<Headers>
			...
			<ul class="second_select">
				...
				<li class="second_jump">
					<i>价格</i><span class="iconfont icon-xialajiantouxiangxia"></span>
					<div class="Price_sort">
						<router-link to="/">从低到高</router-link>
					</div>
				</li>
				<li class="second_jump"><i>筛选</i><span class="iconfont icon-xialajiantouxiangxia"></span></li>
				<li class="second_jump"><i>排序</i><span class="iconfont icon-xialajiantouxiangxia"></span></li>
			</ul>
	...
	export default{
		...
		mounted(){
		 ...
		 methods: {
		 	selectJup(){
		 		console.log(1)
		 		 let jump = document.getElementsByClassName('second_select')[0];
			    // 获取需要滚动的距离
